...
# but you dont want to trigger the callback when they change.
import html
...
@callback(
        Output(component_id='download-figure-object', component_property='da'),
        Input(component_id='download-figure-button', component_property=''),
        State(component_id='sig-a', component_property='value'),
        State(component_id='sig-k', component_property='value'),
        prevent_initial_call=True
)
def download_figure(__, a:float, k:float)->dict:
